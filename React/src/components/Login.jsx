      ...
      <div class="SignupPage">
        <div class="form-container">
            ...
            <form class="form">
              ...
              <input type="Mail" class="input" placeholder="E.mail"/>
              <input type="password" class="input" placeholder="Create Password"/>
              <button class="form-btn">Sign up</button>
            </form>
            <p class="sign-up-label">
              Already have an account?<span class="sign-up-link"><a href="login.html">Login</a></span>
            </p>
            <div class="buttons-container">
              <div class="apple-login-button">
                ...
                <span><a href="https://www.apple.com/">Log in with Apple</a></span>
              </div>
          ...
          c0.001-0.001,0.002-0.001,0.003-0.002l6.19,5.238C36.971,39.205,44,34,44,24C44,22.659,43.862,21.35,43.611,20.083z"></path>
                ...
                <span><a href="https://mail.google.com/">Log in with Google</a></span>
              </div>
            </div>
          </div>
          </div>
